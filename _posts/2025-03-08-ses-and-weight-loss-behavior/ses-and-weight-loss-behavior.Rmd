...
weight3 <- weight3 %>%
  mutate(weight_loss_behavior_type = recode(weight_loss_behavior_type,
                                           "risky_behaviors(laxative, vomit, non-prescription pill, smoke)" = "Perform Risky Behaviors"))

weight3$weight_loss_behavior_type <- factor(weight3$weight_loss_behavior_type, 
                                           levels = c("exercise", "diet_change", "less_eating", "professional_help", "Perform Risky Behaviors", "other"),
                                           labels = c("Exercise", "Change Diet", "Eating Less", "Get Professional Help", "Perform Risky Behaviors", "Other"))
...
ggsave("plot33.png", plot33, width=6, height=4, dpi = 150)
```
